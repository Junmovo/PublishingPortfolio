import { IDetailSubcontentsType } from '@/types/PortfolioType';
  ...
  return (
    <>
      ...
      <div className="flex gap-4">
        <div className="mt-10 flex  border-black bg-black text-white hover:translate-y-[-3px] transition border rounded-full text-[14px] dark:border-white">
          <Link href={HomepageLink} className="p-[10px] px-[15px] flex items-center transition">
            홈페이지 바로가기
