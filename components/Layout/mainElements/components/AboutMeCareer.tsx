        ...
        <div className="ml-10">
          <div className="flex mb-10">
            ...
            <div className=" flex flex-col gap-1  text-[16px] ">
              ...
              <div>
                <S.TitleUnderText>
                  <div>웹디자인, 퍼블리싱, 사이트 유지보수 등 전반적인 사이트 제작업무를 담당하였습니다.</div>
                  <div>
                    자사 관리자 페이지 기능 개발을 하였으며, 매출 및 판매량을 종합하여 쉽게 파악할 수 있는 UI로
                    변경하였습니다.
                  </div>
                  <div>포토샵을 활용한 각종 이벤트 디자인 및 기획을 담당하였습니다.</div>
                  <div>PHP 및 Mysql을 활용하여 기능을 개발 </div>
                </S.TitleUnderText>
              </div>
            </div>
          </div>
          ...
          <div className="mb-4 flex flex-col gap-1">
            <div className="flex">
              ...
              <div className=" flex flex-col gap-1  text-[16px] ">
                ...
                <div>
                  <S.TitleUnderText>
                    <div>(스마트웹&콘텐츠개발)반응형 UI/UX 웹퍼블리셔 전문가 양성과정</div>
                    <div>사용자의 UI/UX를 고려하여, 사용성을 높혔습니다.</div>
                    <div>웹표준을 준수하여 작업하는 방법을 배웠습니다.(HMTL5/CSS)</div>
                    <div>JavaScript & jQuery 사용법을 배웠습니다.</div>
                  </S.TitleUnderText>
                </div>
              </div>
            </div>
