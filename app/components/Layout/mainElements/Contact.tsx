...
const Contact = () => {
  return (
    <div className="xl:w-[1300px] w-full p-4 pb-[70px]  flex flex-col items-center justify-center h-[100vh] m-auto relative  text-center  overflow-hidden lg:overflow-visible sm:p-4">
      ...
      <div className=" mt-4 leading-6 text-gray-700 dark:text-gray-300">
        새로운 기술에 대한 두려움을 극복하고 끊임없이 성장하는 디자이너가 되고 싶습니다. <br></br>변화와 도전을
