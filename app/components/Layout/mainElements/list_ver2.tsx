  ...
  return (
    <>
      <div className="xl:w-[1300px] m-auto pb-[50px] p-6">
        <div>
          <h2 className="text-[64px] font-[400] font-montserrat mb-[30px]">Web Project</h2>
        </div>
        <div>
          <h3 className="text-[24px] font-[600] mb-[30px] font-montserrat leading-6">
            Company
        ...
        <div>
          <h3 className="text-[24px] font-[600] mb-[30px]  mt-[60px] font-montserrat leading-6	">
            Personal
